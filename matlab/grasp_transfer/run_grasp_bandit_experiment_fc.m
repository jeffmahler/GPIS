...
%% run experiment
bandit_comparison_results = compare_bandits(shape_indices, config,true);
save('results/bandits/bandit_comparison_results_fc.mat', 'bandit_comparison_results');
% 
%% accumulate results
...
axis([1000 size(avg_random_simp_regret,1) 0 0.5]); 
% xlim([0, 200]);
% ylim([0, 0.1]);
