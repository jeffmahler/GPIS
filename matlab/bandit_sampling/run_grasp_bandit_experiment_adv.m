...
save('results/bandits/bandit_comparison_results_adv.mat', 'bandit_comparison_results','-v7.3');
% 
%% accumulate results
regret_analysis = analyze_final_regret(bandit_comparison_results,...
                                       config.method_names,config);
save('results/bandits/regret_analysis_adv.mat', 'regret_analysis','-v7.3');
...
axis([1000 size(avg_git98_simp_regret,1)-10 0 1.0]); 
% xlim([0, 200]);
% ylim([0, 0.1]);
