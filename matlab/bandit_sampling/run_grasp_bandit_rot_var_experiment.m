...
textobj = findobj(hobj1, 'type', 'text');
set(textobj, 'Interpreter', 'latex', 'fontsize', 18);
xlabel('Variance in Degrees', 'FontSize', 15);
ylabel('Grasp Samples', 'FontSize', 15);
title('Sensitivity Analysis of Rotational Variance', 'FontSize', 15);
    %axis([1 config.num_iters 0 25e3]);   
                               
hold off; 
save('results/bandits/results_rot_var.mat', 'results_fric_var','-v7.3');
