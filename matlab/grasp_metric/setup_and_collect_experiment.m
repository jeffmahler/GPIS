...
Grasp = Collect_Samples( experimentConfig,gpModel,shapeParams,img,constructionResults)
...
Grasp = [ Grasp; Collect_Samples( experimentConfig,gpModel,shapeParams,img,constructionResults)];


filename = 'squirt_bottle'
