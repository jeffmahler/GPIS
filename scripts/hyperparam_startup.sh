...
GRAD_WEIGHT=$(/usr/share/google/get_metadata_value attributes/grad_weight)
MOMENT_WEIGHT=$(/usr/share/google/get_metadata_value attributes/moment_weight)
NUM_NEAREST=$(/usr/share/google/get_metadata_value attributes/num_nearest)
NN_WEIGHT=$(/usr/share/google/get_metadata_value attributes/nn_weight)
...
weight_grad_x: $GRAD_WEIGHT
weight_grad_y: $GRAD_WEIGHT
weight_gravity: $MOMENT_WEIGHT
prior_neighbor_weight: $NN_WEIGHT
prior_num_neighbors: $NUM_NEAREST
EOF
