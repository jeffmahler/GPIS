...
NUM_GRASPS=$(/usr/share/google/get_metadata_value attributes/num_grasps)
GRASP_SAMPLER=$(/usr/share/google/get_metadata_value attributes/grasp_sampler)
