...
def label_correlated(obj, chunk, config, plot=False,
    ...
    std_ua_rewards = np.std(all_ua_rewards, axis=0)
    std_ts_rewards = np.std(all_ts_rewards, axis=0)
    std_gi_rewards = np.std(all_gi_rewards, axis=0)
    std_ts_corr_rewards = np.std(all_ts_corr_rewards, axis=0)
    std_bucb_corr_rewards = np.std(all_bucb_corr_rewards, axis=0)
